...
import syntaxHighlighterTheme from 'react-syntax-highlighter/dist/esm/styles/hljs/vs2015';
...
- Clone repo [repo link](https://github.com/jonathantcrawford/blog)
- Setup Fleek Account
- Create new hosting project
- Add `.fleek.json` to project root
...
### Setting up your own TLD
- Purchase Domain from Namebase
- Setup HDNS [HDNS Setup](https://www.hdns.io/#macos)
