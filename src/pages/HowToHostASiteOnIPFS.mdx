...
1. Create a new repo or clone this one. <a alt="github repo" rel="noreferrer" href="https://github.com/jonathantcrawford/blog" target="_blank"><FontAwesomeIcon icon={faGithub}/></a>
2. Setup a Fleek Account at [Fleek.co](https://fleek.co/)
3. Select "Hosting" from the side bar and click "Add New Site"
   <img alt="screenshot_1" src={Screenshot_1URL}/>
4. Connect with Github.
   <img alt="screenshot_2" src={Screenshot_2URL}/>
5. Select a repo.
   <img alt="screenshot_3" src={Screenshot_3URL}/>
6. Select "IPFS" from the Hosting Service dropdown.
   <img alt="screenshot_4" src={Screenshot_4URL}/>
7. Choose the branch you want to deploy when commits are pushed.
   ...
   <img alt="screenshot_5" src={Screenshot_5URL}/>
8. You now have a configured Fleek Project! You can now view an overview of your project as well as a list of deployments and other settings.
   <img alt="screenshot_6" src={Screenshot_6URL}/>
...
<img alt="screenshot_7" src={Screenshot_7URL}/>
